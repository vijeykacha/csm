            ...
            >
              ...
              <Link className="dropdown-item d-flex align-items-center" to="/">
                ...
                <div>
                  ...
                  &#8377;75,000 has been deposited into your account!
                </div>
              </Link>
              <Link className="dropdown-item d-flex align-items-center" to="/">
                <div className="mr-3">
            ...
            >
              ...
              <Link className="dropdown-item d-flex align-items-center" to="/">
                ...
                <div className="font-weight-bold">
                  ...
                  <div className="small text-gray-500">Mahesh Singh · 58m</div>
                </div>
              </Link>
              <Link className="dropdown-item d-flex align-items-center" to="/">
                <div className="dropdown-list-image mr-3">
                ...
                <div>
                  ...
                  <div className="small text-gray-500">Riddhi Solanki · 1d</div>
                </div>
              </Link>
              <Link className="dropdown-item d-flex align-items-center" to="/">
                <div className="dropdown-list-image mr-3">
                ...
                <div>
                  ...
                  <div className="small text-gray-500">Raghu Chauhan · 2d</div>
                </div>
              </Link>
              <Link
                className="dropdown-item text-center small text-gray-500"
